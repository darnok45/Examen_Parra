...
<template>
  <nav class="bg-emerald-600 shadow-md text-white">
    <div class="container mx-auto flex items-center justify-between px-4 py-3">
      ...
      <div class="flex items-center space-x-2">
        ...
        >
          ...
          <div
            v-if="totalItems > 0"
            class="p-1 h-4 bg-red-600 rounded-full text-white absolute z-10 -top-2 -right-2 flex justify-center items-center text-xs font-semibold"
          >
            {{ totalItems }}
          </div>
    ...
    <div
      v-if="isOpen"
      class="md:hidden px-4 pb-3 space-y-2 bg-emerald-700"
    >
